...
window.addEventListener('DOMContentLoaded', (event) => {
	...
	const alertYellowTransit = document.querySelector(
		'.uuid-alert-yellow-transit',
	);
	const alertYellowDelivered = document.querySelector(
		'.uuid-alert-yellow-delivered',
	);
	const alertRedNotFound = document.querySelector(
		'.uuid-alert-red-not-found',
	);
	...
	document.getElementById('insert-uuid-button-accept').addEventListener(
		'click',
		() => {
